"""This module constructs a player and adds them to a list of dictionaries which contains information about each player object.
Within the module one can choose and check a player object, which is then read and written into a local json file as well as a 
player list. 
"""
import highscore
import json
...
class Player:
    ...
    def __init__(self, player_id, last_rounds_played=0, total_rounds_played=0, games_played=0,
        ...
        """Construct player object, defaults set so that player info
        can be overrided as they increase their stats.
        """
